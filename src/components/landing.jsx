...
const Profile = () => {
    ...
    const currentProperty = JSON.parse(sessionStorage.getItem('selectedProperty'));
    const usersDataString = localStorage.getItem('usersData');
    const usersData = usersDataString ? JSON.parse(usersDataString) : [];
    const currentCategory = JSON.parse(sessionStorage.getItem('selectedCategory'));
        ...
        <div className="container">
            <Navbar expand="lg" className="bg-body-tertiary">
                <Container fluid>
                    ...
                    <Nav.Item className='selected-property' >{currentProperty.propertyName}</Nav.Item>
                    <Nav className="me-auto my-2 my-lg-0" style={{ maxHeight: '100px' }} navbarScroll>
                            <NavDropdown title={currentCategory? currentCategory : "Categories" } id="navbarScrollingDropdown">
