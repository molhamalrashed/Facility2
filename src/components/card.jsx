...
function MovieRender({ property }) {
    ...
    const renderPropertyDetails = () => {
        ...
        return Object.entries(property) // convert object to array of key-value pairs
            ...
            .slice(0, 15)
            .map(([key, value]) => ( 
                <p key={key} className="property-detail">
            ...
            <Card.Body>
                ...
                <Card.Text>
                    {showFullDescription ? (
                        ...
                        <p className="property-detail">{property.description.length > 100 ? `${property.description.substring(0, 100)}...` : property.description}</p>
                    )}
                </Card.Text>
